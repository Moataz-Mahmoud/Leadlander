...
describe('Login page test cases', function () {
    ...
    it('Login successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    loginPage.setUsername(protractor_1.browser.params.login.username);
                    loginPage.setPassword(protractor_1.browser.params.login.password);
                    loginPage.clickSignOnButton();
                    return [4 /*yield*/, protractor_1.browser.wait(protractor_1.ExpectedConditions.presenceOf(protractor_1.element(protractor_1.By.css('.user-name'))))];
                case 1:
                    _a.sent();
                    expect(protractor_1.element(protractor_1.By.css('.user-name')).getAttribute('innerText')).toContain('Moataz Mahmoud');
    ...
    it('Forgot password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    loginPage.clickForgotPassword();
                    loginPage.setForgotPasswordMailInupt(protractor_1.browser.params.login.username);
                    return [4 /*yield*/, loginPage.clickSendResetEmail()];
                case 1:
                    _a.sent();
